...
/**
 * This is the item provider adapter for a {@link ma6icmodel.Computer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComputerItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Computer_adapters_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Computer_adapters_feature", "_UI_Computer_type"),
				 Ma6icmodelPackage.Literals.COMPUTER__ADAPTERS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Ma6icmodelPackage.Literals.COMPUTER__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Ma6icmodelPackage.Literals.COMPUTER__TELEMETRY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Ma6icmodelPackage.Literals.COMPUTER__TELEMETRY,
