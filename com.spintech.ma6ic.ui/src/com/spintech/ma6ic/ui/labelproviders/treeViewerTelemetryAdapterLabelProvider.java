...
public class treeViewerTelemetryAdapterLabelProvider extends LabelProvider {
	...
	public String getText(Object element) {
			...
			//	return computer.getName();
				...
				if (object instanceof Subsystem) {
					...
					EList<Telemetry> telemetry = adapter.getTelemetry();
					for (Telemetry telemetry2 : telemetry) {
						if (telemetry2.getParameter().equalsIgnoreCase("OBDH Interface")) {
							String value = telemetry2.getValue();
							if (value.equals("1")) {
								return "SpaceWire";
							} else if (value.equals("2")) {
	...
	private Color subsystemColor = new Color(Display.getDefault(), new RGBA(134,140,152,0)); //47, 91, 110255); //47, 91, 110
